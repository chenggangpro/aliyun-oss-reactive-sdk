...
class NoSuchBucketExceptionTest extends OssExceptionTest {

    @Test
    public void test(@Random String bucketName) {
        NoSuchBucketException noSuchBucketException = new NoSuchBucketException(errorCode, errorMessage, requestId, hostId, bucketName);
        assertThat(noSuchBucketException, notNullValue());
    }
